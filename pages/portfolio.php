...
<body>
    <div class="container">
            ...
            <ul>
                <?php foreach ($projets as $projet): ?>
                    <li>
                        ...
                        <?php endif; ?>
                    </li> <?php if (isset($_SESSION['utilisateur_id']) && $_SESSION['utilisateur_id'] == $utilisateur['id']): ?>
                        <a href="delete_projet.php?id=<?= $projet['id'] ?>"
        ...
        <?php if (isset($_SESSION['utilisateur_id']) && $_SESSION['utilisateur_id'] == $utilisateur['id']): ?>
            <a href="publier.php" class="btn">Publier mon portfolio</a>
